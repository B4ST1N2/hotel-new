...
public class DiaDeSol extends Alojamiento {
    ...
    public DiaDeSol(String tipo, String nombre, int calificacion, String ciudad, String actividades, boolean refrigerio, double precioActividad, int cantidadPersonas, Boolean disponibilidad) {
    ...
    public double calcularPrecioTotal(LocalDate diaInicio, LocalDate diaFin) {
        return CalculadorPrecioTotal.calcularPrecioTotal(diaInicio, diaFin, this.precioActividad);
    }
